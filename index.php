...
<html lang="en">
<head>
	<title>Intercambio Libros</title>
	<meta charset="UTF-8">
...
<body>
	<div class="row m-0 p-0">
			<div class="d-none d-sm-none d-md-block d-lg-block  col-md-7 col-lg-8 p-0">
				<img src="images/fondo_2.jpg" class="w-100 vh-100" alt="">
				<div class="carousel-caption d-none d-md-block">
			        <h5>Intercambio de Libros</h5>
			        <p class="text-white">Leer nos abre una VENTANA al mundo</p>
			     </div>
			</div>
